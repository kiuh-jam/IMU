import torch
import load_dataset
import LSTM_Rnn_module
import matplotlib.pyplot as plt
import numpy as np
# 设置支持中文的字体，SimHei 是常见的中文字体
plt.rcParams['font.family'] = ['SimHei']  # 或者 'Microsoft YaHei'
plt.rcParams['axes.unicode_minus'] = False  # 解决负号显示问题
directory = r'C:\Users\13106\Desktop\2024\编程\传感器信号去噪\深度学习方法\LSTM-RNN\data'
save_path = 'C:\\Users\\13106\\Desktop\\2024\\编程\\传感器信号去噪\\深度学习方法\\LSTM-RNN'
dataset = load_dataset.Accleration_Dataset(directory)
data = dataset.data
# print(data.shape)
model = LSTM_Rnn_module.LSTM_Rnn(data, [1]*20, step=20)
...
model.load_state_dict(torch.load(r'C:\Users\13106\Desktop\2024\编程\传感器信号去噪\深度学习方法\LSTM-RNN\model.pth'))
model.eval()
model.to(device='cpu')
