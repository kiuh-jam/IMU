...
if __name__ == '__main__':
    #折线的轨迹重建——初步成功
    acc_filepath = r'C:\Users\13106\Desktop\code\IMU\IMUData\折线\Linear Acceleration.csv'
    gyro_filepath = r'C:\Users\13106\Desktop\code\IMU\IMUData\折线\Gyroscope.csv'
    ...
    # exit()
    # result = change_point.change_point_detection(acc_data[:5000,0], 10)
    # print(result)
    # exit()
    ...
    # A = [14850, 17020, 19700, 20420, 36350, 40300, 43530, 45370] # 折线
    # process_data_x = signal_segement.process_signal_segments(acc_data_x, A, example_even_processor, example_odd_processor,save_path='processed_data_x_linear_zhexian.npy')
    # process_data_y = signal_segement.process_signal_segments(acc_data_y, A, example_even_processor, example_odd_processor,save_path='processed_data_y_linear_zhexian.npy')
    # process_data_z = signal_segement.process_signal_segments(acc_data_z, A, example_even_processor, example_odd_processor,save_path='processed_data_z_linear_zhexian.npy')
    process_data_x = WT.simple_WT(np.load('processed_data_x_linear_zhexian.npy'),4)
    process_data_y = WT.simple_WT(np.load('processed_data_y_linear_zhexian.npy'),4)
    process_data_z = WT.simple_WT(np.load('processed_data_z_linear_zhexian.npy'),4)
